...
import { addDecisionFlowBasicInfo, updateDecisionFlowBasicInfo } from '../../../../action/decision'
import { DECISION_STRATEGY_NEW_BASICINFO, DECISION_STRATEGY_NEW_CONFIG } from '../../../../common/decision_constant'
...
class BasicInfo extends React.Component {
  ...
  addBasicInfo = async (data) => {
    await addDecisionFlowBasicInfo(data).then(res => {
      const { content = {} } = res
      this.props.setTreeId({ ...content, redirect: DECISION_STRATEGY_NEW_CONFIG })
  ...
  updateBasicInfo = async (data) => {
    ...
    await updateDecisionFlowBasicInfo(data).then(res => {
      const { content = {} } = res
      this.props.setTreeId({ ...content, redirect: DECISION_STRATEGY_NEW_BASICINFO })
